...
i = 1
    ...
    Do Until i >= 35
        ThisWorkbook.Worksheets("Urok10").Range("H" & i) = i
        i = i + 1
        
        If ThisWorkbook.Worksheets("Urok10").Range("H" & i) = "Stop" Then
            Exit Do
        End If
    Loop
...
i = 1
    Do
        checker = InputBox("Enter 'stop' to stop the cycle. Cycle: " & i)
        i = i + 1
    Loop Until checker = "stop"
